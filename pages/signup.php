...
<body class="min-h-screen flex flex-col">
    <section class="bg-cover bg-center bg-no-repeat flex flex-col item-center justify-center min-h-screen md:px-100 px-5" style="background-image: url('../assets/2login-bg.jpg')">
