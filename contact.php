  ...
  <html>
    ...
    <body class="min-h-screen flex flex-col">
        ...
        <section class="bg-[#2D3748] flex flex-col h-screen text-white md:px-30 px-5 pt-20">
            ...
            <p class="text-lg">To report a player, reset your password, or to ask a generic question about our server, join our <a href="https://discord.gg/" class="text-blue-500 underline">Discord</a>!</p>
